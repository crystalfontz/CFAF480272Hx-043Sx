...
#define FLASH_LENGTH_SPLASH (32640UL) // sectors: 7
#define FLASH_SECTOR_CLOUDS (9UL)
#define FLASH_LENGTH_CLOUDS (-2147450880UL) // sectors: 524296
#define FLASH_SECTOR_ICE_FPV_512x300 (9UL)
#define FLASH_LENGTH_ICE_FPV_512x300 (4096UL) // sectors: 1
//Total sectors = 4096, free sectors = 4086
//Total flash = 16777216, free flash = 16736256
//
...
#define HPP   (400)    // Horizontal Pixel Padding (tot=863: 862~1056~1200)
...
#define VLP   (10)     // Vertical Line Padding (tot=511: 510~525~650)
                      // EVE needs at least 1 here
// Define the constants needed by the EVE based on the timing
