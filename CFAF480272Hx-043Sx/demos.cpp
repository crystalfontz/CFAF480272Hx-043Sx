...
#if (0==BMP_SCROLL) //1 for scroll, 0 for static bitmap
  FWol=FLASH_SETBITMAP(FWol,FLASH_SECTOR_SPLASH,EVE_FORMAT_COMPRESSED_RGBA_ASTC_8x8_KHR,480,272);
#else // (0==BMP_SCROLL) //1 for scroll, 0 for static bitmap
  FWol=FLASH_SETBITMAP(FWol,FLASH_SECTOR_CLOUDS,EVE_FORMAT_COMPRESSED_RGBA_ASTC_8x8_KHR,480,272);
